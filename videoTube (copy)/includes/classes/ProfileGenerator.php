...
class ProfileGenerator {
    ...
    {
        return "<ul class='nav nav-tabs nav-justified md-tabs indigo' id='myTabJust' role='tablist'>
                      <li class='nav-item'>
                        <a class='nav-link active' id='videos-tab' data-toggle='tab' href='#videos' role='tab' aria-controls='home-just'
                          aria-selected='true'>Videos</a>
                      </li>
                      <li class='nav-item'>
                        <a class='nav-link' id='about-tab' data-toggle='tab' href='#about' role='tab' aria-controls='profile-just'
    ...
    public function createContentSection()
    {
        ...
        $aboutSection = $this->createAboutSection();
            ...
            return "<div class='tab-content card pt-5 channelContent' id='myTabContentJust'>
                      
                      <div class='tab-pane fade show active profileVideos' id='videos' role='tabpanel' aria-labelledby='videos-tab'>
                            $videoGridHtml
                      </div>
